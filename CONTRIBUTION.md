# JEC Project Contributor License Agreement _(CLA)_

Thank you for your interest in contributing to JEC Project ("We" or "Us").
...
```shell
    JEC Project
    Name: Pascal Echemann
    Title: Product Owner
    Address: Cherche Midi
    06250 France
